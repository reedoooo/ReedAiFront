...
export const FileUpload = ({ iconStyle, setFileInput, editor }) => {
  const {
    state: { isFilePickerOpen, selectedFiles, previewUrls },
    actions: { setIsFilePickerOpen, setSelectedFiles, setPreviewUrls },
  } = useChatStore();
  ...
  const handleFileChange = async (
    ...
    for (const file of files) {
      await processFile(file, editor, fileDataRef, setUploadedFiles);
    }
  };
